...
export const Calendar = () => {
    ...
    return (
        <div style={{ backgroundColor: "tomato", display: "flex", justifyContent: "center" }}>
...
const CustomCalendar = ({ currentCalendar, cityName }: CustomCalendarProps) => {
    ...
    return (
        <div style={{ border: "3px solid black", display: "flex", width: "30em", padding: "1em", margin: "1em", backgroundColor: "whitesmoke", flexDirection: "column", alignItems: "center" }}>
            <h1>{cityName}</h1>
...
const CustomTime = ({ currentTime }: CustomTimeProps) => {
